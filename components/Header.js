...
function Header({ placeholder }) {
    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
            ...
            {searchInput && (
            <div className="flex flex-col col-span-3 sm:mx-auto mt-5">
                ...
                <div className="flex items-center border-b mb-4">
                    ...
                    <input value={noOfGuests} onChange={ e => setNoOfGuests(e.target.value)} min={1} type="number" className="w-12 pl-2 text-lg text-red-400 outline-none" />
                </div>
                <div className="flex">
